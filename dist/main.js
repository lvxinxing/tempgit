    ...
    1: [function (require, module, exports) {
        ...
        Board.prototype._set = function (x, y, role) {
            ...
            if (winner == R.com) {
                ...
                $.modal({
                    title: "恭喜你赢了！",
                    text: '<div class="swiper-container" style="width: 150px;padding-top:20px;">' +
                    '<div class="swiper-pagination"></div>' +
                    '<div class="swiper-wrapper">' +
                    '<div class="swiper-slide" style="text-align:center;"><img src="./img/qrcode_for_gh.jpg" height="150" style="display:block"></div>' +
                    '</div>' +
                    '</div>' +
                    '<div class="weui_dialog_title">长按二维码，识别图中二维码，领取优惠券</div>',
                    buttons: [{ text: "确定", onClick: function () { self.stop(); } }]
                });
                //$.alert("恭喜你赢了！长按识别图中二维码领取优惠券", function () {
                //self.stop();
                //});
            }
        }
